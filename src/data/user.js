const INFO = {
	...
	about: {
		...
		description: {
			...
			p3: "Throughout this role, I became fascinated with connections- how the web resembled the human brain, with APIs acting as dendrites, recieving packets by means of field potentials. I dedicated all of my free time to studying code, and five years later was landing jobs in hybrid marketing development roles.",
